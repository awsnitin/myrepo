    ...
    def __init__(
        ...
        **kwargs) -> None:
        ...
        origin = cloudfront.OriginAccessIdentity(
            self,
            "s3origin",
            comment='CodeCatalystModern3TierBlueprint'
        )
        ...
        endpoint = ssm.StringParameter.from_string_parameter_attributes(
            self,
            "apiEndpointSSMParam",
            parameter_name=f"/{environment_name}{app_name}/apiEndpoint",
        ).string_value
    ...
    def __init__(
        ...
        **kwargs) -> None:
        ...
        ddb_table = ddb.Table(
            ...
            "app_table",
            removal_policy=RemovalPolicy.DESTROY,
            table_name=f"{environment_name}{app_name}Table",
        ...
        endpoint_proxy = apigw.HttpApi(
            self,
            f"{environment_name}{app_name}App"
        )
    ...
    def __init__(self,
        ...
        **kwargs) -> None:
        ...
        ecrRepo = ecr.Repository(
            self,
            "AppContainerRepo",
            repository_name=f"{environment_name}{app_name}".lower(),
            removal_policy=RemovalPolicy.DESTROY
        )
